...
reports_id_csv = 'C:\\Sid Data\\BITS\\4th Sem\\Yifan code\\Yifan Code Base\\1.Data\\wrapperdb_public_reports.csv'
...
def generate_svd_recommendation_df() -> pd.DataFrame:
    ...
    recomendation_reportname_df = pd.merge(recommendation_df_nmf, df_reports_id, how = 'left', on= 'report_id')
...
print('Algorithm\t RMSE\t\t MAE')
print()
print('SVD', '\t\t', round(svd_cv['test_time'].avg(), 4), '\t', round(svd_cv['fit_time'].avg(), 4))
